...
class AnchorWhirlpoolDecoder:
    ...
    def __init__(self, rpc_url: str):
        ...
        """
        self.PROGRAM_ID = "whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc"  # Orca Whirlpool program ID
            ...
            "ticks": [
                {
                    ...
                    "rewardGrowthsOutside": [str(growth) for growth in tick.reward_growths_outside]
                }
