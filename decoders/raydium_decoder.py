...
class AnchorRaydiumDecoder:
    ...
    def __init__(self, rpc_url: str):
        ...
        """
        self.PROGRAM_ID = "CAMMCzo5YL8w4VFF8KVHrK22GGUsp5VTaW7grrKgrWqK"  # Raydium AMM V3 program ID
    ...
    def decode_protocol_position_state(self, decoded) -> Dict:
        ...
        return {
            ...
            "tokenFeesOwed0": str(decoded.token_fees_owed0),
            "tokenFeesOwed1": str(decoded.token_fees_owed1),
            "rewardGrowthInside": [str(growth) for growth in decoded.reward_growth_inside]
        }
    ...
    def decode_tick_array_state(self, decoded) -> Dict:
        ...
        return {
            ...
            "ticks": [
                {
                    "initialized": tick.initialized if hasattr(tick, 'initialized') else False,
                    "tick": tick.tick,
                    ...
                    "rewardGrowthsOutsideX64": [str(growth) for growth in tick.reward_growths_outside_x64]
                }
                for tick in decoded.ticks if hasattr(tick, 'tick')  # Only include valid ticks
            ]
        }
